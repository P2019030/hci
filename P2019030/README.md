...
| 1. | Άσκηση προγραμματισμού ή βιογραφικό  (SW) |2
| 1. | Άσκηση γραμμής εντολών: set-up the main dependencies and demonstrate your base system |3
| 4 | Άσκηση προγραμματισμού: Button excercise. |
